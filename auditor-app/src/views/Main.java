...
public class Main extends javax.swing.JFrame {
    ...
    void calTrialbalance() {
        try {
            ...
            JasperReport r = JasperCompileManager.compileReport(pathTrialBalance);
    ...
    void calProftloss() {
        try {
            ...
            JasperReport r = JasperCompileManager.compileReport(pathProfitLoss);
    ...
    void calBalancesheet() {
        try {
            ...
            JasperReport r = JasperCompileManager.compileReport(pathBalanceSheet);
